...
├── edi_837_parser
    ...
    ├── elements
    │   ├── __init__.py
    │   ├── adjustment_group_code.py
    │   ├── adjustment_reason_code.py
    │   ├── amount_qualifier.py
    │   ├── authorization_information_qualifier.py
    │   ├── claim_status.py
    │   ├── date.py
    │   ├── date_qualifier.py
    │   ├── dollars.py
    │   ├── entity_code.py
    │   ├── entity_type.py
    │   ├── identification_code_qualifier.py
    │   ├── identifier.py
    │   ├── integer.py
    │   ├── payment_method.py
    │   ├── reference_qualifier.py
    │   ├── service_code.py
    │   ├── service_modifier.py
    │   ├── service_qualifier.py
    │   └── utilities.py
    ├── loops
    │   ├── __init__.py
    │   ├── billingprovider.py
    ...
    │   ├── claim.py
    │   ├── date.py
    │   ├── demographic_information.py
    │   ├── dept_contact_information.py
    │   ├── diagnosis.py
    │   ├── drug_identification.py
    │   ├── drug_quantity.py
    │   ├── entity.py
    │   ├── location.py
    │   ├── note.py
    ...
    │   ├── reference.py
    │   ├── service.py
    │   ├── service_adjustment.py
    │   ├── service_line_adjudication.py
    │   ├── serviceline.py
    │   ├── subscriber.py
    │   └── utilities.py
    └── transaction_set
...
--------------------------------------------------------------------------------
 ...
 68 | ```
 69 | EDI-parser-837/
 70 | ├── extract_edi_837_business_format.py  # Main parser script
 71 | ├── config.py                           # Configuration file
 72 | ├── info.txt                           # Comprehensive documentation
 73 | ├── README.md                          # This file
 74 | ├── .gitignore                         # Git ignore rules
 75 | └── edi_837_parser/                    # Parser package
 76 |     └── __init__.py                    # Package initialization
 77 | ```
 78 | 
 79 | ## 🔧 Configuration
 80 | 
...
116 | ✅ Processed 10 files, extracted 53 claims so far
117 | ...
118 | 📊 EXTRACTION SUMMARY:
119 | Total claims extracted: 1,994
120 | ✅ EDI_Claims_Output.csv saved with 1,994 records
121 | ✅ EDI_ClaimDetail_Output.csv saved with 4,445 records
122 | ✅ COMPANY_SETUP_Output.csv saved with 112 records
123 | ```
124 | 
...
--------------------------------------------------------------------------------
 1 | from edi_837_parser.elements import Element
 2 | 
 3 | # https://ushik.ahrq.gov/dr.ui.drValueDomain_View?system=mdr&ValueDomainID=4933000&CallingRoutine=$CallingRoutine
amp;OrganizationID=3&RecordOffset=11&Referer=ValueDomain
...
--------------------------------------------------------------------------------
https://raw.githubusercontent.com/pop-singh/EDI-parser-837/a780478c182d22aec4c1f82f77fa71e313fe84bd/edi_837_parser/loops/__init__.py
...
--------------------------------------------------------------------------------
https://raw.githubusercontent.com/pop-singh/EDI-parser-837/a780478c182d22aec4c1f82f77fa71e313fe84bd/edi_837_parser/segments/__init__.py
...
--------------------------------------------------------------------------------
https://raw.githubusercontent.com/pop-singh/EDI-parser-837/a780478c182d22aec4c1f82f77fa71e313fe84bd/edi_837_parser/transaction_set/__init__.py
...
1578 |         print(f"❌ EDI directory not found: {edi_directory}")
...
1589 |         print(f"❌ Permission denied accessing directory: {edi_directory}")
1590 |         return
1591 |     
1592 |     if not edi_files:
1593 |         print(f"❌ No EDI files found in directory: {edi_directory}")
1594 |         print(f"Looking for files with extensions: {EDI_FILE_EXTENSIONS}")
1595 |         return
1596 |     
1597 |     print(f"✅ Found {len(edi_files)} EDI files in: {edi_directory}")
1598 |     
...
1635 |             if i % 10 == 0:
1636 |                 print(f"✅ Processed {i} files, extracted {total_claims_extracted} claims so far")
1637 |         
...
1652 |         print(f"✅ Business format data saved to: {business_output_file}")
...
2228 |             print(f"✅ EDI_Claims_Output.csv saved with {len(claims_records)} records")
2229 |         
...
2233 |             print(f"✅ EDI_ClaimDetail_Output.csv saved with {len(claim_detail_records)} records")
2234 |         
...
2293 |             print(f"✅ COMPANY_SETUP_Output.csv saved with {len(company_setup_records)} records")
2294 |         else:
2295 |             print("⚠️ No company setup records found")
2296 |         
...
--------------------------------------------------------------------------------
  ...
  42 | 
  43 | ┌─────────────────────────────────────────────────────────────┐
  44 | │                    EDI837BusinessParser                     │
  45 | ├─────────────────────────────────────────────────────────────┤
  46 | │ 1. Initialization & Lookup Tables                          │
  47 | │    - Medical code dictionaries                             │
  48 | │    - EDI code mappings                                      │
  49 | │    - Business format templates                             │
  50 | ├─────────────────────────────────────────────────────────────┤
  51 | │ 2. EDI Segment Parsers (20+ methods)                       │
  52 | │    - parse_isa_segment() - Interchange control             │
  53 | │    - parse_nm1_segment() - Names/entities                  │
  54 | │    - parse_clm_segment() - Claim information               │
  55 | │    - parse_sv1_segment() - Service lines                   │
  56 | ├─────────────────────────────────────────────────────────────┤
  57 | │ 3. Business Format Converter                               │
  58 | │    - convert_to_business_format()                          │
  59 | │    - extract_claim_info()                                  │
  60 | │    - extract_providers()                                   │
  61 | │    - extract_service_lines()                               │
  62 | ├─────────────────────────────────────────────────────────────┤
  63 | │ 4. Data Export System                                       │
  64 | │    - export_to_csv() - Multiple CSV formats                │
  65 | │    - create_company_setup() - Trading partner data         │
  66 | ├─────────────────────────────────────────────────────────────┤
  67 | │ 5. File Processing Engine                                   │
  68 | │    - process_edi_files() - Batch processing                │
  69 | │    - parse_edi_file() - Individual file parsing            │
  70 | │    - Progress tracking & error handling                    │
  71 | └─────────────────────────────────────────────────────────────┘
  72 | 
  73 | DATA FLOW DIAGRAM:
  74 | ------------------
  75 | EDI Files → Parse Segments → Extract Business Data → Convert to JSON → Export CSV
  76 |     ↓              ↓               ↓                    ↓            ↓
  ...
  80 | 
  81 | 2. 🔧 CLASS STRUCTURE & INITIALIZATION
  82 | ======================================
  83 | 
 ...
 171 | 
 172 | 3. 🏥 COMPREHENSIVE MEDICAL CODE LIBRARIES
 173 | ===========================================
 174 | 
 ...
 435 |         # Track progress
 436 |         if i % 10 == 0:
 437 |             print(f"✅ Processed {i} files, extracted {len(all_claims)} claims so far")
 438 | 
 439 | 🔄 PROCESSING FLOW
 440 | ==================
 ...
 465 | 
 466 | 🔧 TECHNICAL IMPLEMENTATION DETAILS
 467 | ===================================
 468 | 
 ...
 498 | 
 499 | 🏥 HEALTHCARE DOMAIN KNOWLEDGE
 500 | ==============================
 501 | 
 ...
 506 | - Hierarchical Levels (HL): Provider → Subscriber → Patient → Claim
 507 | 
 ...
 531 | 4.
 532 |  🔍 EDI SEGMENT PARSING METHODS (DETAILED)
 533 | ============================================
 534 | 
 ...
 821 | 
 822 | 5. 🔄 BUSINESS FORMAT CONVERSION ENGINE (DETAILED)
 823 | ==================================================
 824 | 
 ...
 829 | -----------------------
 830 | ┌─────────────────────────────────────────────────────────────┐
 831 | │                Business Format Converter                    │
 832 | ├─────────────────────────────────────────────────────────────┤
 833 | │ Input: Raw EDI Segments                                     │
 834 | │ ┌─────────────────────────────────────────────────────────┐ │
 835 | │ │ ISA*00*...*~                                            │ │
 836 | │ │ GS*HC*...*~                                             │ │
 837 | │ │ ST*837*...*~                                            │ │
 838 | │ │ BHT*0019*00*...*~                                       │ │
 839 | │ │ NM1*85*2*PROVIDER*...*~                                 │ │
 840 | │ │ CLM*CLAIM123*125.00*...*~                               │ │
 841 | │ │ SV1*HC:99213*75.00*...*~                                │ │
 842 | │ └─────────────────────────────────────────────────────────┘ │
 843 | ├─────────────────────────────────────────────────────────────┤
 844 | │ Processing Steps:                                           │
 845 | │ 1. Extract Transaction Info                                 │
 846 | │ 2. Group Segments by Hierarchy                             │
 847 | │ 3. Extract Claims                                           │
 848 | │ 4. Extract Providers                                        │
 849 | │ 5. Extract Service Lines                                    │
 850 | │ 6. Enrich with Medical Codes                               │
 851 | │ 7. Build Business Objects                                   │
 852 | ├─────────────────────────────────────────────────────────────┤
 853 | │ Output: Business Format JSON                                │
 854 | │ ┌─────────────────────────────────────────────────────────┐ │
 855 | │ │ {                                                       │ │
 856 | │ │   "id": "uuid-claim-id",                                │ │
 857 | │ │   "objectType": "CLAIM",                                │ │
 858 | │ │   "patientControlNumber": "CLAIM123",                   │ │
 859 | │ │   "chargeAmount": 125.00,                               │ │
 860 | │ │   "subscriber": {...},                                  │ │
 861 | │ │   "providers": [...],                                   │ │
 862 | │ │   "serviceLines": [...]                                 │ │
 863 | │ │ }                                                       │ │
...
1263 | 
1264 | 6. 🔄 DYNAMIC DATA EXTRACTION (DETAILED)
1265 | ========================================
1266 | 
...
1271 | ------------------------------
1272 | ┌─────────────────────────────────────────────────────────────┐
1273 | │                    Dynamic Extraction                       │
1274 | ├─────────────────────────────────────────────────────────────┤
1275 | │ ❌ HARDCODED APPROACH:                                      │
1276 | │    if claim_id == "CLAIM123":                               │
1277 | │        provider_name = "ABC Medical Center"                 │
1278 | │        amount = 125.00                                      │
1279 | ├─────────────────────────────────────────────────────────────┤
1280 | │ ✅ DYNAMIC APPROACH:                                        │
1281 | │    claim_id = clm_segment.get('claim_submitter_identifier') │
1282 | │    provider_name = nm1_segment.get('name_last_or_org')      │
1283 | │    amount = float(clm_segment.get('monetary_amount'))       │
1284 | ├─────────────────────────────────────────────────────────────┤
1285 | │ BENEFITS:                                                   │
1286 | │ • Works with ANY EDI file                                   │
1287 | │ • No maintenance for new data                               │
1288 | │ • Scales to millions of claims                              │
1289 | │ • Handles all provider types                                │
1290 | │ • Processes any medical codes                               │
1291 | └─────────────────────────────────────────────────────────────┘
1292 | 
